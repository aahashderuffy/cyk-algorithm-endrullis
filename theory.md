...
<div style="padding: 20px;">
            <h1>Cocke-Younger-Kasami-Algorithmus - Theorie und Beispiel</h1>
                ...
                <ht3> CYK-Algorithmus von Cocke, Younger und Kasami (aktueller Algorithmus)</ht3>
                    ...
                    <br>
                        <zentriert>
                        <img title="Neuer CYK-Algorithm von Dr. Jörg Endrullis" height="600" alt="Bild zur neuen Berechnung mit dem neuen CYK-Algorithmus" src="/assets/images/old cyk algorithm.png">
                        </zentriert>
                ...
                <ht4> CYK-Algorithmus von Jörg Endrullis (neuer Algorithmus)</ht4>
                    <p>
                        ...
                        <br>
                            <zentriert>
                                <img title="Neuer CYK-Algorithm von Dr. Jörg Endrullis" height="600" alt="Bild zur neuen Berechnung mit dem neuen CYK-Algorithmus" src="/assets/images/new cyk algorithm.png">
                            </zentriert>
                    ...
                    <br>
                    <br>
                    Zum Schluss haben wir das Wort "abbb". Da haben wir drei verschiedene Kombinationsmöglichkeiten:
                    "a" und "bbb", "ab" und "bb", "abb" und "b". 
                    <br>
                    Für "a" und "bbb": "AS, AB"
                    <br>
                    Für "ab" und "bb": "SA, BA"
...
<img title="a title" height="400" alt="Alt text" src="">
